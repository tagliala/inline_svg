...
- Drop Support for Webpacker, Legacy Ruby (< 3.2), and Legacy Rails (< 7.2). [#163](https://github.com/jamesmartin/inline_svg/pull/163). Thanks, [@tagliala](https://github.com/tagliala)
